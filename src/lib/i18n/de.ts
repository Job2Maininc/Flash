...
export const de = {
  ...
  home: {
    ...
    howDemo: {
      ...
      pass: "Weiter",
      swipeHint:
        "Im Call: nach rechts wischen zum Behalten, nach links für Weiter. Pfeiltasten tun dasselbe.",
      swipeCardLabel: "Live-Anruf — wischen zum Behalten oder Weiter",
      keptLive: "Aus dem Call behalten. Jetzt auf deiner Liste.",
      passedLive: "Weiter. Nächster Call.",
      deckEmpty: "Demo fertig — starte einen echten Call.",
      matchesEmpty: "Im Call nach rechts wischen füllt deine Liste",
