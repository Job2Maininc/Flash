export const en = {
  ...
  home: {
    ...
    howDemo: {
      ...
      pass: "Next",
      swipeHint:
        "During the call: swipe right to keep, left to pass. Arrow keys do the same.",
      swipeCardLabel: "Live call — swipe to keep or pass",
      keptLive: "Kept from the call. Now on your list.",
      passedLive: "Passed. Next call.",
      deckEmpty: "That’s the demo — try a real call.",
      matchesEmpty: "Swipe right during a call to fill your list",
      soundOn: "Ringtone on",
